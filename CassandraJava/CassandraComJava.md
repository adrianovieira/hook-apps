...
<center>![Cassandra Inicializado](imagens/arquitetura_cassandra.png)</center>
...
<center>![Python na Linha de Comando](imagens/pythoncmd.png)</center>
...
<center>![Java na Linha de Comando](imagens/javacmd.png)</center>
...
<center>![Cassandra Inicializado](imagens/cassandrabat.png)</center>
...
<center>![Projeto Maven no Eclipse](imagens/projetomaveneclipse.png)</center>
...
<center>![Dependência Driver Java](imagens/dependenciadriverjava.png)</center>
...
<center>![CQL Tabela Músicas](imagens/createtablesongscassandra.png)</center>
...
<center>![CQL Tabela Playlists](imagens/createtableplaylistscassandra.png)</center>
...
![](imagens/criacaoschema.png)

![](imagens/criacaoschema1.png)
...
![](imagens/songmainclass.png)

Ao rodar essa classe, aparecerá no console a seguinte saída:

<center>![Saída no Console do SongServiceMain](imagens/songservicemainconsole1.png)</center>

Após a execução da classe, o modelo de dados ficou da seguinte forma:

<center>![Cassandra Model](imagens/CassandraModel.png)</center>
...
![](imagens/songdaoclassparte1.png)

![](imagens/songdaoclassparte2.png)

E a classe PlaylistsDAO:

![](imagens/playlistdao.png)

![](imagens/playlistdao1.png)
...
<center>![CQLSH](imagens/cqlshbatselect.png)</center>
